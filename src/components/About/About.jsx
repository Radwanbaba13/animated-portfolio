      ...
      <motion.div className="content" initial="hidden" animate={inView ? "visible" : "hidden"}>
        ...
        {isMobile ? (
          <motion.p variants={textVariants2}>
            With a <b> BEng in Software Engineering</b>, I&rsquo;ve always approached engineering with a blend of analytical prowess and creative innovation. My goal? To build seamless, end-to-end experiences that push the boundaries of what&rsquo;s possible on the web.
          </motion.p>
        ) : (
          <motion.p variants={textVariants2}>
            With a <b> BEng in Software Engineering</b>, I&rsquo;ve always approached engineering with a blend of analytical prowess and creative innovation. Harnessing my skills as a full-stack developer, I delve into each layer of development with precision and creativity. My journey is fueled by an unwavering commitment to excellence and a quest for the next breakthrough in technology. My goal? To build seamless, end-to-end experiences that push the boundaries of what&rsquo;s possible on the web.
          </motion.p>
        )}
        ...
        <motion.div className="technologies" animate={inView ? "visible" : "hidden"}>
          ...
          <motion.div className="groups">
            ...
            <Technology categoryName={"AI/ML"} techArray={machineLearning} index={5} />
            <Technology categoryName={"Testing"} techArray={testingFrameworks} index={6} />
          </motion.div>
        </motion.div>
      </motion.div>
